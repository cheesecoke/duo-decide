...
describe("whoLine", () => {
	const cases: [string, ReturnType<typeof queue>, string | null, string][] = [
		...
		// The mock's empty wording (:786) rather than "0 open, 0 settled".
		["an empty queue", queue(), "Sam", "You & Sam · nothing in the queue yet"],
		...
		["no partner, empty queue", queue(), null, "You · nothing in the queue yet"],
	];
